 ...
 * @date 2 July 201
 */
public class Transmission_old extends Subsystem
{
...
public static enum DebugState
    {
    DEBUG_NONE, DEBUG_ONLY_NON_ZERO, DEBUG_PID_DATA, DEBUG_MOTOR_DATA, DEBUG_ALL
    }
 ...
 * @written 2 July 201
 */
public Transmission_old (SpeedController rightSpeedController,
...
public void driveLeftMotor (double motorValue)
{
    ...
    if (this.leftSpeedController == null)
        ...
        if ((this.getDebugState() == DebugState.DEBUG_MOTOR_DATA) ||
            ...
            System.out
                    .println(
                            "Left (front) motor is null in driveLeftMotor()");
            }
    ...
    this.leftSpeedController
            .set(motorValue * this.leftMotorDirection.val);
}
...
public void driveRightMotor (double motorValue)
{
    ...
    if (this.rightSpeedController == null)
        ...
        if ((this.getDebugState() == DebugState.DEBUG_MOTOR_DATA) ||
            ...
            System.out
                    .println(
                            "Right (front) motor is null in driveRightMotor()");
            }
...
public double getGearPercentage (int gear)
{
    if ((gear < 1) || (gear > this.MAX_GEAR))
        ...
        if (this.debugState == DebugState.DEBUG_MOTOR_DATA)
            ...
            System.out
                    .println(
                            "Invalid gear to set in getGearPercentage()");
            }
        return 0.0;
        }
