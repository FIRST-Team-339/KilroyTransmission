 ...
 *          -------------------------------------------------------
 */
public final class Transmission_old_old
{
/**
 * -------------------------------------------------------
 *
...
// Previous measurements of the left/right encoders for use with the
// brake() method.

// actually the distance value that it last stopped at NOT THE DISTANCE
 ...
 *          -------------------------------------------------------
 */
public Transmission_old_old (final DoubleSolenoid transmissionSolenoids)
{
 ...
 *          -------------------------------------------------------
 */
public Transmission_old_old (final Relay transmissionRelay)
{
 ...
 *          -------------------------------------------------------
 */
public Transmission_old_old (final SpeedController rightSpeedController,
        final SpeedController leftSpeedController)
{
    this.isFourWheel = false;
    this.oneOrRightSpeedController = rightSpeedController;
        ...
        final double rotation)
{
    if ((this.leftSpeedController == null) ||
        ...
        if (this.getDebugState() == debugStateValues.DEBUG_ALL)
            {
            System.out.println(
                    "MECANUM controls(): motor is null");
            }
        return;
        }
    ...
    if ((this.usePID() == true) && (this.isPIDEnabled() == true))
        {
        tempMagnitude = this.mapSoftwareJoystickValues(
                tempMagnitude,
        ...
        boolean driveStraight)
{
    ...
    if (driveStraight == true)
        ...
        final double resultantY = ((this.leftMotorEncoder
                .getDistance()
                +
                this.leftRearMotorEncoder.getDistance()) +
                this.oneOrRightMotorEncoder.getDistance() +
        ...
        final double resultantX = (((this.leftMotorEncoder
                .getDistance()
                -
                this.leftRearMotorEncoder.getDistance()) -
                this.oneOrRightMotorEncoder.getDistance()) +
...
// motor and gearing
{
    ...
    // --------------------------------------
    final double mappedValue = absJoystickInputValue * (gearPercentage /
            deadbandRange);
    // --------------------------------------
...
public brakeReturns stop ()
{
    ...
    // else if both encoders are NOT equal to null
        ...
        else if (directionChanged(this.leftRearMotorEncoder,
                this.rightRearMotorEncoder) == true)
            {
            this.setJoystickDeadbandRange(savedDeadBandRange);
            stopTimer.stop();
